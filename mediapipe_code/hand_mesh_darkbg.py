...
with mp_holistic.Holistic(min_detection_confidence=0.5, min_tracking_confidence=0.6) as holistic:
    ...
    while True:
        ...
        mp_drawing.draw_landmarks(blank, result.right_hand_landmarks, mp_holistic.HAND_CONNECTIONS)
        mp_drawing.draw_landmarks(blank, result.left_hand_landmarks, mp_holistic.HAND_CONNECTIONS)
